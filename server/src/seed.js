...
async function seedDatabase() {
  try {
    ...
    console.log(
      "🧹 Cleaning existing test collections (preserving nothing for a clean state)...",
    );
    await Promise.all([
      User.deleteMany({}),
      Course.deleteMany({}),
    ...
    const students = await User.create([
      ...
      },
      {
        ...
        isBlocked: true,
        blockReason:
          "Violation of community guidelines - spamming course discussions",
    ...
    const courseConfigs = [
      {
        ...
        subTitle:
          "Build scalable production-ready web apps with React 19, Node, Express & MongoDB",
        description:
          "Comprehensive end-to-end masterclass covering authentication, state management, REST APIs, WebSockets, payment gateways, and cloud deployment.",
      ...
      },
      {
        ...
        subTitle:
          "Ace FAANG coding interviews with deep dive problem solving and optimization",
        description:
          "Master essential DSA patterns including Dynamic Programming, Graph Traversals, Trees, Heaps, and Bit Manipulation with 150+ solved challenges.",
        ...
        isPublished: true,
        thumbnail:
          "https://images.unsplash.com/photo-1516116211227-bbc13c72b226?w=800&auto=format&fit=crop&q=80",
      ...
      },
      {
        ...
        subTitle:
          "From wireframes to production-ready scalable design tokens and components",
        description:
          "Learn user research, wireframing, interactive prototyping in Figma, and translating designs seamlessly into clean Tailwind CSS code.",
      ...
      },
      {
        ...
        subTitle:
          "CI/CD pipelines, Docker containers, Helm charts, and AWS EKS orchestrations",
        description:
          "Master modern DevOps and Cloud architecture. Deploy highly available, secure, and auto-scaling microservices on Amazon Web Services.",
      ...
      },
      {
        ...
        subTitle:
          "Build Neural Networks, Computer Vision, and LLM applications using PyTorch",
        description:
          "Deep dive into machine learning foundations, transformers, attention mechanisms, fine-tuning LLMs, and deploying AI models to production.",
      ...
      },
      {
        ...
        subTitle:
          "Build slick iOS and Android mobile apps from a single codebase",
        description:
          "Covers navigation, camera integrations, push notifications, offline storage, and publishing directly to App Store & Google Play Store.",
      ...
      },
      {
        ...
        subTitle:
          "Automate repetitive daily tasks, extract web data, and build FAST APIs",
        description:
          "Hands-on guide to BeautifulSoup, Selenium, Requests, Pandas, and building modern asynchronous APIs with FastAPI.",
      ...
      },
      {
        ...
        description:
          "Strangler fig pattern, event-driven architectures, database per service, and distributed tracing.",
        category: "devops",
        price: 2499,
        level: "Advance",
        status: "rejected",
        rejectionReason:
          "Course syllabus is incomplete and audio quality in demo lectures does not meet requirements.",
        isPublished: false,
        thumbnail:
    ...
    for (const config of courseConfigs) {
      ...
      const lecturesToCreate = sampleLectures
        .slice(0, lectureCount)
        .map((lec) => ({
    ...
    await Progress.insertMany([
      ...
      // Priya: 60% in MERN, 25% in DSA, 0% in AI (not started)
      {
        ...
        courseId: cMern.course._id,
        lecturesCompleted: [
          cMern.lectures[0]._id,
          cMern.lectures[1]._id,
          cMern.lectures[2]._id,
        ],
      },
      {
        userId: priya._id,
    ...
    await ReviewAndRating.insertMany([
      {
        ...
        rating: 5,
        review:
          "Exceptional MERN course! The real-world microservices, JWT auth, and WebSocket integration were total game changers.",
      },
      {
        userId: priya._id,
        courseId: cMern.course._id,
        rating: 5,
        review:
          "Super clean code structure and very clear explanation of backend patterns. Highly recommend to everyone!",
      },
      {
        userId: david._id,
        courseId: cMern.course._id,
        rating: 4,
        review:
          "Great real-world depth. The Redux Toolkit setup and component architecture were super helpful.",
      },
      {
        userId: john._id,
        courseId: cDsa.course._id,
        rating: 5,
        review:
          "The best DSA course in Java. Dynamic Programming and Graph algorithms finally clicked for me!",
      },
      {
        userId: sophia._id,
        courseId: cDsa.course._id,
        rating: 5,
        review:
          "Detailed dry runs and edge case handling. Helped me clear two technical interview rounds!",
      },
      {
        userId: michael._id,
        courseId: cUiUx.course._id,
        rating: 5,
        review:
          "Incredible UI/UX insights. The design system and Figma auto-layout modules alone are worth 10x the price.",
      },
      {
        userId: sophia._id,
        courseId: cUiUx.course._id,
        rating: 4,
        review:
          "Loved the hands-on design tokens and transition to React Tailwind code.",
      },
      {
        userId: michael._id,
        courseId: cCloud.course._id,
        rating: 5,
        review:
          "DevOps made straightforward with hands-on AWS EKS deployments and Helm charts.",
      },
      {
        userId: priya._id,
        courseId: cAi.course._id,
        rating: 5,
        review:
          "State of the art coverage of Deep Learning and Transformer models with PyTorch.",
      },
    ]);
    ...
    // ─────────────────────────────────────────────────────────────
    console.log(
      "💳 Creating Payment transactions (historical analytics data)...",
    );
    ...
    await Notification.insertMany([
      {
        ...
        message:
          "John Doe enrolled in your course Full-Stack MERN Architecture & Masterclass.",
      ...
      },
      {
        ...
        message:
          "Your course Applied Artificial Intelligence & Deep Learning has been approved by admin.",
      ...
      },
      {
        ...
        message:
          "Your course Cross-Platform Mobile Apps with React Native is currently under admin review.",
        isRead: false,
      },
      {
        recipient: john._id,
        ...
        message:
          "Congratulations! You have completed Full-Stack MERN Architecture & Masterclass and your certificate is ready.",
        realtedCourse: cMern.course._id,
        isRead: false,
      },
      {
        ...
        message:
          "Emily Watson submitted a new course: Cross-Platform Mobile Apps with React Native & Expo.",
        isRead: false,
      },
    ]);
    ...
    await Message.insertMany([
      {
        ...
        sender: john._id,
        content:
          "Hello everyone! Excited to learn scalable MERN architecture here.",
      ...
      },
      {
        ...
        sender: sarah._id,
        content:
          "Welcome John and everyone! Feel free to ask any architectural questions in this chat.",
      ...
      },
      {
        ...
        sender: priya._id,
        content:
          "Lecture 3 on WebSocket real-time rooms was brilliant Dr. Sarah! Thank you.",
      ...
      },
      {
        ...
        sender: sarah._id,
        content:
          "Glad you found it helpful Priya! Up next is production Redis caching.",
        createdAt: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000),
      },
    ]);
    ...
    console.log(`\n👨‍🏫 INSTRUCTORS:`);
    console.log(
      `    1. Email: sarah.chen@instructor.com      | Password: password123`,
    );
    console.log(
      `    2. Email: alex.rodriguez@instructor.com  | Password: password123`,
    );
    console.log(
      `    3. Email: emily.watson@instructor.com    | Password: password123`,
    );
    console.log(
      `    4. Email: vikram.sharma@instructor.com   | Password: password123`,
    );
    console.log(`\n🎓 STUDENTS:`);
    console.log(
      `    1. Email: john.doe@student.com          | Password: password123 (Completed MERN + Certificate)`,
    );
    console.log(
      `    2. Email: priya.patel@student.com       | Password: password123`,
    );
    console.log(
      `    3. Email: michael.brown@student.com     | Password: password123 (Completed UI/UX + Certificate)`,
    );
    console.log(
      `    4. Email: sophia.martinez@student.com   | Password: password123 (Completed DSA + Certificate)`,
    );
    console.log(
      `    5. Email: david.kim@student.com         | Password: password123`,
    );
    console.log(
      `    6. Email: ananya.singh@student.com      | Password: password123`,
    );
    console.log(
      `    7. Email: blocked.user@student.com      | Password: password123 (Blocked Account test)`,
    );
    console.log("========================================================\n");
